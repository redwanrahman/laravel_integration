        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p1.png')}}" alt="">
              </div>
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p2.png')}}" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p3.png')}}" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p4.png')}}" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p5.png')}}" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('fontend/images/p6.png')}}" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
